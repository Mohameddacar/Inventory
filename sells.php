         ...
         <!-- Main content -->
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Sells Registrations</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="ins_up_del/sells_reg.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">sells_id</label>
                    <input type="text" class="form-control" id="sells_id" name="sells_id" placeholder="Enter sells_id">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select name="customer_id" id="customer_id" class="form-control">
                        <option value="customer_id">Select Suppliers</option>                   
                        <?php
...
<script>
    function validatePurchaseForm() {
        ...
        if (orderDate === "" || status === "" || quantity === "" || unitPrice === "" || customerId === "" || userId === "") {
